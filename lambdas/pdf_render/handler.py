...
def _data_only_url_fetcher():
    # data: only, so injected HTML (once submission data reaches the template) can't SSRF or
    # read local files. WeasyPrint 69 URLFetcher; byte-identical to app/services/pdf.py. See D-019.
